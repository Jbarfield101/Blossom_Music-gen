...
export default function DndDmEvents() {
      ...
      <div className="pantheon">
        <section className="pantheon-grid">
          ...
          {!loading && items.length === 0 && (
            <div className="muted">No events found in this folder.</div>
          )}
        </section>
        <section className="pantheon-reader">
          {selected ? (
            ...
            <div className="muted">Select an event to view details.</div>
          )}
        </section>
      </div>
    </>
